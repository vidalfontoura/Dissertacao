...
As configurações utilizadas nos AEMOs foi definida baseada no tamanho das instâncias. A Tabela \ref{tab:popConfiguration} apresenta para cada instância: o tamanho da instância, o tamanho da população e número máximo de avaliações.
