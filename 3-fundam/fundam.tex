...
Este capítulo apresenta o referencial teórico para as estratégias heurísticas que foram modeladas para o problema PDP nesta Dissertação. Inicialmente, uma breve apresentação sobre algoritmos evolutivos e otimização multi objetiva é introduzida. Em seguida dois algoritmos multi objetivos são apresentados pois estes foram utilizados nesta Dissertação. As hiper heurísticas são apresentadas em sequência pois estas abordagens foram exploradas durante o período de desenvolvimento dessa Dissertação. Finalmente programação genética e evolução gramatical são apresentadas pois estes conceitos foram utilizados na Metodologia deste trabalho.
